  ...
  return (
    <>
      ...
      <article className="container py-14 md:py-20 max-w-[820px]">
        ...
        <h1 className="font-sans font-semibold text-[44px] md:text-[64px] tracking-[-0.035em] leading-[1.02] mb-8">Car insurance for young drivers in Australia</h1>
        <p className="text-[19px] md:text-[20px] text-muted-foreground leading-[1.55] mb-12 max-w-[680px]">A practical guide to car insurance for drivers under 25 in Australia, why premiums sit higher, the levers that may bring them down, and how to compare policies properly when you're new behind the wheel.</p>

        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">Anyone who has shopped car insurance in their early twenties has probably had the same experience: the quote feels disproportionately high, and the difference between insurers seems even bigger than usual. There are real reasons for that, and there are real things you can do about it.</p>
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">This guide walks through both. If you're newer to the topic in general, the <Link to="/car-insurance/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">car insurance hub</Link> covers the underlying basics first.</p>

        <h2 className="font-sans font-semibold text-[28px] md:text-[36px] tracking-[-0.025em] leading-[1.1] mt-16 mb-5">What is "young driver" car insurance?</h2>
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">There's no separate product called young driver insurance in Australia. Instead, most insurers price standard policies (third party, third party fire and theft, or comprehensive) higher when the regular driver is under 25, or charge an additional age-based excess at claim time when an under-25 was driving.</p>
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">A handful of insurers run dedicated brands aimed at younger drivers, usually with telematics-based pricing or particular policy features. Whether they end up cheaper than a mainstream insurer's quote depends on the individual.</p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-3 text-[16px] leading-[1.65] text-foreground/85">
          ...
          <li><strong>The PDS and TMD</strong>, worth reading. See our <Link to="/guides/how-to-read-a-pds/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">how to read a PDS</Link> guide for which sections to focus on.</li>
        </ul>

        <h2 className="font-sans font-semibold text-[28px] md:text-[36px] tracking-[-0.025em] leading-[1.1] mt-16 mb-5">How to compare car insurance as a young driver</h2>
        <ol className="list-decimal pl-6 mb-6 space-y-3 text-[16px] leading-[1.65] text-foreground/85">
          ...
          <li><strong>Get matched quotes</strong> from at least three insurers, including one that runs a telematics product. The <Link to="/car-insurance/quotes/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">car insurance quotes</Link> page lists what to keep constant across each one.</li>
        ...
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">Our <Link to="/car-insurance/compare/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">compare car insurance</Link> page covers the broader framework if you want a refresher.</p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-3 text-[16px] leading-[1.65] text-foreground/85">
          ...
          <li><strong>Going with the cheapest policy without checking what's excluded</strong>, covered in detail on our <Link to="/car-insurance/cheap/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">cheap car insurance</Link> page.</li>
        ...
        <h2 className="font-sans font-semibold text-[28px] md:text-[36px] tracking-[-0.025em] leading-[1.1] mt-16 mb-5">What affects how much a young driver pays</h2>
        <ul className="list-disc pl-6 mb-6 space-y-3 text-[16px] leading-[1.65] text-foreground/85">
        ...
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">The <Link to="/car-insurance/cost/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">car insurance cost</Link> page covers the wider set of factors that affect any driver's premium.</p>
        ...
        <section className="mt-20 bg-secondary/60 border border-border rounded-3xl p-8 md:p-12">
          ...
          <p className="text-[16px] text-muted-foreground leading-[1.6] mb-7 max-w-2xl">Young driver premiums move quickly with small changes, vehicle, excess, telematics. Comparing matched quotes is the fastest way to see what your real range looks like.</p>
          <div className="flex flex-wrap gap-3">
            ...
            <Link to="/car-insurance/cheap/" className="inline-flex items-center gap-2 bg-card border border-border text-foreground px-6 py-3.5 rounded-full text-[14.5px] font-medium hover:bg-secondary transition">Lowering your premium</Link>
          </div>
