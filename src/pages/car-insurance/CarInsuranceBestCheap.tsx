      ...
      <article className="container py-12 md:py-16 max-w-4xl">
        ...
        <div className="grid gap-4 md:grid-cols-2 mb-8">
          <div className="border border-border rounded-lg p-5 bg-card">
            ...
            <Link to="/reviews/bingle/" className="text-sm text-primary hover:underline">
          ...
          <div className="border border-border rounded-lg p-5 bg-card">
            ...
            <Link to="/reviews/budget-direct/" className="text-sm text-primary hover:underline">
          ...
          <div className="border border-border rounded-lg p-5 bg-card">
            ...
            <Link to="/reviews/coles/" className="text-sm text-primary hover:underline">
          ...
          <div className="border border-border rounded-lg p-5 bg-card">
            ...
            <Link to="/reviews/real-insurance/" className="text-sm text-primary hover:underline">
          ...
          <div className="border border-border rounded-lg p-5 bg-card">
            ...
            <Link to="/reviews/woolworths/" className="text-sm text-primary hover:underline">
