  ...
  return (
    <>
      ...
      <article className="container py-12 md:py-16 max-w-4xl">
        ...
        <h1 className="font-sans font-extrabold text-4xl md:text-5xl tracking-tight mb-6">Third party car insurance in Australia</h1>
        <p className="text-lg text-muted-foreground leading-relaxed mb-10 max-w-2xl">A plain-English guide to third party property car insurance in Australia — what it covers, what it doesn't, how it compares to CTP and comprehensive, and the situations it may suit.</p>

        <p className="text-base leading-relaxed mb-5">Third party car insurance often gets dismissed as the bargain-basement option, but for the right car and driver, it can be a perfectly reasonable choice. Understanding exactly what it does — and doesn't — cover is the difference between an informed decision and a regret at claim time.</p>
        <p className="text-base leading-relaxed mb-5">If you'd rather start with the broader basics, the <Link to="/car-insurance/" className="text-primary hover:underline">car insurance hub</Link> covers all four types of car insurance side by side.</p>

        <h2 className="font-sans font-extrabold text-2xl md:text-3xl tracking-tight mt-12 mb-4">What is third party car insurance?</h2>
        <p className="text-base leading-relaxed mb-5">Third party property car insurance is an optional policy that covers damage your vehicle causes to other people's property — most often, their car. It generally doesn't cover damage to your own vehicle. There are usually three flavours people group under "third party":</p>
        <ul className="list-disc pl-6 mb-6 space-y-2 leading-relaxed">
          ...
          <li><strong>CTP</strong> — compulsory third party. Covers injury to people, not vehicle damage. Required to register your car. The <Link to="/car-insurance/ctp/" className="text-primary hover:underline">CTP / green slip</Link> page covers this in more depth.</li>
        </ul>
        <p className="text-base leading-relaxed mb-5">When most people say "third party car insurance" they mean the first or second of these.</p>
        ...
        <h2 className="font-sans font-extrabold text-2xl md:text-3xl tracking-tight mt-12 mb-4">How to compare third party policies</h2>
        <ol className="list-decimal pl-6 mb-6 space-y-3 leading-relaxed">
          ...
          <li><strong>Get matched quotes</strong> — same vehicle, same drivers, same excess. Our <Link to="/car-insurance/quotes/" className="text-primary hover:underline">car insurance quotes</Link> page lists what to keep constant.</li>
        ...
        <h2 className="font-sans font-extrabold text-2xl md:text-3xl tracking-tight mt-12 mb-4">What affects whether third party may suit you</h2>
        <ul className="list-disc pl-6 mb-6 space-y-3 leading-relaxed">
        ...
        <p className="text-base leading-relaxed mb-5">For more on what shapes the price of any car insurance, see our <Link to="/car-insurance/cost/" className="text-primary hover:underline">car insurance cost</Link> page.</p>
        ...
        <section className="mt-16 bg-card border border-border rounded-lg p-6 md:p-8">
          ...
          <p className="text-base text-muted-foreground leading-relaxed mb-6 max-w-2xl">Quoting third party and comprehensive side by side for the same vehicle is usually the fastest way to see whether the cheaper option really suits.</p>
          <div className="flex flex-wrap gap-3">
            ...
            <Link to="/car-insurance/comprehensive/" className="inline-flex items-center gap-2 bg-secondary text-foreground px-5 py-3 rounded-md text-sm font-medium hover:bg-muted transition">Comprehensive cover</Link>
