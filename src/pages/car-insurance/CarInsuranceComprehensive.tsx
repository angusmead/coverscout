  ...
  return (
    <>
      ...
      <article className="container py-14 md:py-20 max-w-[820px]">
        ...
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">Our <Link to="/car-insurance/compare/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">compare car insurance</Link> page covers the broader framework if you'd like more detail.</p>
        ...
        <h2 className="font-sans font-semibold text-[28px] md:text-[36px] tracking-[-0.025em] leading-[1.1] mt-16 mb-5">What affects comprehensive premiums</h2>
        <ul className="list-disc pl-6 mb-6 space-y-3 text-[16px] leading-[1.65] text-foreground/85">
          <li><strong>Driver age and history.</strong> See <Link to="/car-insurance/young-drivers/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">car insurance for young drivers</Link> for the lower-experience end.</li>
        ...
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">For a wider breakdown of pricing factors, see <Link to="/car-insurance/cost/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">car insurance cost</Link>.</p>
