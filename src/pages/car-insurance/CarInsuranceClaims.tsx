  ...
  return (
    <>
      ...
      <article className="container py-14 md:py-20 max-w-[820px]">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-3 text-[16px] leading-[1.65] text-foreground/85">
          <li><strong>The policy you have.</strong> Comprehensive, third party, and CTP cover different events. The <Link to="/car-insurance/comprehensive/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">comprehensive</Link> and <Link to="/car-insurance/third-party/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">third party</Link> pages cover what's typically included.</li>
