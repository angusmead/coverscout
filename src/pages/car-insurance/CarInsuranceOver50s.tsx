  ...
  return (
    <>
      ...
      <article className="container py-12 md:py-16 max-w-4xl">
        ...
        <h1 className="font-sans font-extrabold text-4xl md:text-5xl tracking-tight mb-6">Car insurance for over 50s in Australia</h1>
        <p className="text-lg text-muted-foreground leading-relaxed mb-10 max-w-2xl">A clear guide to car insurance for drivers in their 50s, 60s and beyond in Australia — how age changes the way insurers price you, which features are worth weighing, and how to compare policies that may suit.</p>

        <p className="text-base leading-relaxed mb-5">Once you're past the age where insurers treat you as inexperienced, the conversation shifts. Premiums become more about driving record, vehicle, and lifestyle than age alone. That said, age does still play a role — particularly later in life — and a few features become more important than they were a couple of decades ago.</p>
        <p className="text-base leading-relaxed mb-5">If you'd like a refresher on the underlying basics, the <Link to="/car-insurance/" className="text-primary hover:underline">car insurance hub</Link> covers the fundamentals.</p>

        <h2 className="font-sans font-extrabold text-2xl md:text-3xl tracking-tight mt-12 mb-4">What is over 50s car insurance?</h2>
        <p className="text-base leading-relaxed mb-5">It isn't a separate product category in Australia, but several insurers market policies aimed at the over-50s segment. They typically emphasise stable pricing, choice of repairer, and features that suit drivers with lower annual kilometres or who don't commute daily.</p>
        <p className="text-base leading-relaxed mb-5">Standard insurers also generally rate drivers in this age band well — provided the driving record is clean — so it's worth comparing both specialist and mainstream options before deciding.</p>
        ...
        <ul className="list-disc pl-6 mb-6 space-y-3 leading-relaxed">
          ...
          <li><strong>Agreed value vs market value</strong> — for a long-held car, an agreed value can avoid arguments at claim time. See our <Link to="/guides/market-value-vs-agreed-value/" className="text-primary hover:underline">market value vs agreed value</Link> guide.</li>
        ...
        <h2 className="font-sans font-extrabold text-2xl md:text-3xl tracking-tight mt-12 mb-4">How to compare car insurance for over 50s</h2>
        <ol className="list-decimal pl-6 mb-6 space-y-3 leading-relaxed">
          <li><strong>Decide on cover type</strong> based on the value of the car. <Link to="/car-insurance/comprehensive/" className="text-primary hover:underline">Comprehensive</Link> still suits most newer or higher-value vehicles; <Link to="/car-insurance/third-party/" className="text-primary hover:underline">third party</Link> may suit older ones.</li>
          <li><strong>Get matched quotes</strong> — at least one specialist over-50s insurer and two mainstream insurers — using the same inputs. See <Link to="/car-insurance/quotes/" className="text-primary hover:underline">car insurance quotes</Link> for what to keep constant.</li>
        ...
        <h2 className="font-sans font-extrabold text-2xl md:text-3xl tracking-tight mt-12 mb-4">What affects what over 50s pay</h2>
        <ul className="list-disc pl-6 mb-6 space-y-3 leading-relaxed">
        ...
        <p className="text-base leading-relaxed mb-5">For the wider set of factors, the <Link to="/car-insurance/cost/" className="text-primary hover:underline">car insurance cost</Link> page is the broader explainer.</p>
        ...
        <section className="mt-16 bg-card border border-border rounded-lg p-6 md:p-8">
          ...
          <p className="text-base text-muted-foreground leading-relaxed mb-6 max-w-2xl">Comparing matched quotes from a specialist insurer alongside mainstream options is the simplest way to see whether the over-50s pitch actually translates into a better price for you.</p>
