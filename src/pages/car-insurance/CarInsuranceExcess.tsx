  ...
  return (
    <>
      ...
      <article className="container py-14 md:py-20 max-w-[820px]">
        ...
        <h1 className="font-sans font-semibold text-[44px] md:text-[64px] tracking-[-0.035em] leading-[1.02] mb-8">Car insurance excess explained: how it works in Australia</h1>
        <p className="text-[19px] md:text-[20px] text-muted-foreground leading-[1.55] mb-12 max-w-[680px]">A plain-English guide to car insurance excess in Australia, what it is, the different types, how it interacts with your premium, and what to weigh when choosing yours.</p>

        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">Excess is one of those words that gets glossed over until you're actually claiming. It's also one of the most useful levers you have on your premium, provided you understand all the moving pieces. This guide unpacks the lot.</p>
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">If you're newer to car insurance generally, the <Link to="/car-insurance/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">car insurance hub</Link> covers the surrounding basics first.</p>

        <h2 className="font-sans font-semibold text-[28px] md:text-[36px] tracking-[-0.025em] leading-[1.1] mt-16 mb-5">What is car insurance excess?</h2>
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">An excess is the amount you contribute toward each claim before the insurer pays the rest. It's set at policy start and it usually applies to most claim types, with exceptions and additions spelled out in the PDS.</p>
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">Excess does two jobs at once. It reduces the cost of small claims for the insurer, which keeps the underlying premium lower than it would otherwise be. And it gives you, the policyholder, a financial nudge to think twice before lodging a tiny claim.</p>

        <h2 className="font-sans font-semibold text-[28px] md:text-[36px] tracking-[-0.025em] leading-[1.1] mt-16 mb-5">Key types of excess to understand</h2>
        ...
        <p className="text-[16px] leading-[1.65] text-foreground/85 mb-5">A single claim can attract more than one of these at once. The PDS sets the rules.</p>

        <h2 className="font-sans font-semibold text-[28px] md:text-[36px] tracking-[-0.025em] leading-[1.1] mt-16 mb-5">How to choose your excess level</h2>
        <ol className="list-decimal pl-6 mb-6 space-y-3 text-[16px] leading-[1.65] text-foreground/85">
          ...
          <li><strong>Compare across insurers.</strong> Different insurers price excess steps differently. The <Link to="/car-insurance/compare/" className="text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">compare car insurance</Link> page covers the matched-input approach.</li>
        </ol>
        ...
        <h2 className="font-sans font-semibold text-[28px] md:text-[36px] tracking-[-0.025em] leading-[1.1] mt-16 mb-5">What affects which excess may suit you</h2>
        <ul className="list-disc pl-6 mb-6 space-y-3 text-[16px] leading-[1.65] text-foreground/85">
        ...
        <section className="mt-20 bg-secondary/60 border border-border rounded-3xl p-8 md:p-12">
          ...
          <p className="text-[16px] text-muted-foreground leading-[1.6] mb-7 max-w-2xl">Re-quoting at multiple excess levels is the easiest way to see how each insurer prices the trade-off. The pages below cover the comparison framework and what affects the underlying price.</p>
          <div className="flex flex-wrap gap-3">
            ...
            <Link to="/car-insurance/cost/" className="inline-flex items-center gap-2 bg-card border border-border text-foreground px-6 py-3.5 rounded-full text-[14.5px] font-medium hover:bg-secondary transition">What affects cost</Link>
