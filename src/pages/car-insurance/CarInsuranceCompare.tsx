      ...
      <article className="container py-12 md:py-16 max-w-4xl">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-3 leading-relaxed">
          ...
          <li>
            ...
            <Link to="/car-insurance/nsw/" className="text-primary hover:underline">
              NSW
            </Link>
            ,{" "}
            <Link to="/car-insurance/vic/" className="text-primary hover:underline">
              Victoria
            </Link>
            , and{" "}
            <Link to="/car-insurance/qld/" className="text-primary hover:underline">
              Queensland
            </Link>{" "}
