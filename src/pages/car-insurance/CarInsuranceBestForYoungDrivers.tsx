      ...
      <article className="container py-14 md:py-20 max-w-[820px]">
        ...
        <div className="grid gap-4 md:grid-cols-2 mb-8">
          ...
          <div className="border border-border rounded-lg p-5 bg-card">
            ...
            <Link to="/reviews/youi/" className="text-sm text-brand-blue font-medium underline decoration-brand-blue/40 underline-offset-[4px] hover:decoration-brand-blue">
