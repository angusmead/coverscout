...
export type ProviderProfile = {
  ...
  path: string;
  /** Outbound URL to the insurer's website (no affiliate params yet). */
  website: string;
  metaTitle: string;
...
export const PROVIDERS: ProviderProfile[] = [
  ...
  // ─── Bingle ───────────────────────────────────────────────
  {
    ...
    name: "Bingle",
    path: "/reviews/bingle/",
    website: "https://www.bingle.com.au",
  ...
  // ─── Coles ────────────────────────────────────────────────
  {
    ...
    name: "Coles",
    path: "/reviews/coles/",
    website: "https://www.coles.com.au/insurance",
  ...
  // ─── Woolworths ───────────────────────────────────────────
  {
    ...
    website: "https://insurance.everyday.com.au",
  ...
  // ─── Real Insurance ───────────────────────────────────────
  {
    ...
    website: "https://www.realinsurance.com.au",
  ...
  // ─── Rollin' ──────────────────────────────────────────────
  {
    ...
    name: "Rollin'",
    path: "/reviews/rollin/",
    website: "https://rollininsurance.com.au",
    metaTitle: "Rollin' Car Insurance Review: Safe 'n Save, Features and How It Compares",
    metaDescription: "Rollin' car insurance overview, its app-based Safe 'n Save driving-rewards program, who it may suit, and how it may compare with other Australian car insurers.",
    lead: "A plain-English overview of Rollin' car insurance in Australia, a digital-first comprehensive insurer that rewards safer driving with monthly premium discounts through its Safe 'n Save app program.",
    overview: [
    ...
    coverTypes: COMMON_COVER,
    features: [
      { heading: "Safe 'n Save monthly scoring", body: "The Rollin' app tracks driving behaviour, phone use, braking, speeding, acceleration and cornering, and scores it out of 100 each month. Your score determines the discount applied to next month's premium. Optional for personal-use policies and required for business-use policies." },
      { heading: "Tiered discount up to 15%", body: "Score 95+ earns 15% off the base premium, 90 to 94 earns 10%, 85 to 89 earns 5%, and below 85 earns no discount. For the first two consecutive monthly policies, a 10% intro discount applies before your score takes over from month three." },
      { heading: "Month-to-month policies", body: "Policies are billed monthly with no cancellation fees or lock-in contract. Cover continues each month while the policy is active." },
      { heading: "App requirements", body: "All Listed Drivers should have the Rollin' app installed and running while driving. A 'no trip data' excess can apply at claim time if app data isn't available." },
      { heading: "Claims process", body: "Claims are lodged through the Rollin' app or web portal, with the underwriting insurer handling assessment and repair coordination. Safe 'n Save driving data isn't used in claim assessment." },
    ...
    faqs: [
      { q: "How does Rollin's Safe 'n Save program work?", a: "The Rollin' app tracks driving behaviour (phone use, braking, speeding, acceleration and cornering) for all Listed Drivers and produces a monthly Policy Score out of 100. Score 95+ earns 15% off the base premium for the next month, 90 to 94 earns 10%, 85 to 89 earns 5%, and below 85 earns no discount. For the first two consecutive months a 10% intro discount applies before the score takes over from month three." },
      { q: "Is Safe 'n Save optional?", a: "Safe 'n Save is optional for personal-use policies and required for business-use policies. The exact terms and conditions sit in the Rollin' PDS and the Premium, Excess & Discounts Guide." },
      ...
      { q: "Is Rollin' cheaper than other Australian car insurance brands?", a: "It depends on your driving and your monthly Policy Score. Higher-scoring drivers can save up to 15% on the base premium each month. Lower-scoring months earn no discount, in which case the maths often favours flat-rate budget brands. Quoting Rollin' alongside both budget and mainstream insurers with identical inputs is the only reliable test." },
      { q: "Does Rollin' use my driving data when I make a claim?", a: "Rollin' states that Safe 'n Save driving data isn't used in claim assessment, and that location data and detected events aren't passed to the claims team in the event of an incident. The full position is set out in the Rollin' privacy policy and PDS." },
      { q: "How do I lodge a Rollin' claim?", a: "Claims are lodged through the Rollin' app or web portal, with the underwriting insurer handling assessment and repair coordination. The full claims process and your obligations sit in the PDS." },
    ],
  },
];
