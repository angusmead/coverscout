...
export const ROUTES_META: RouteMeta[] = [
  ...
  { path: "/car-insurance/best-for-young-drivers/", title: "Best Car Insurance for Young Drivers in Australia (Comparison Guide)", description: "How to compare car insurance as a young driver in Australia, why premiums are higher, the insurers worth shortlisting, and the levers that move the price.", breadcrumbs: [HOME, carHub, { name: "Best for young drivers", url: "/car-insurance/best-for-young-drivers/" }] },
  { path: "/car-insurance/best-cheap/", title: "Best Cheap Car Insurance in Australia: Honest Picks That Don't Cut the Wrong Corners", description: "Which Australian car insurers tend to price competitively, what cheap policies often strip back, and how to find car insurance that's both cheap and worth taking.", breadcrumbs: [HOME, carHub, { name: "Best cheap", url: "/car-insurance/best-cheap/" }] },
  { path: "/car-insurance/best-comprehensive/", title: "Best Comprehensive Car Insurance in Australia (How to Choose)", description: "Which Australian insurers are worth shortlisting for comprehensive cover, what features matter beyond the headline premium, and how to land on a policy that may suit you.", breadcrumbs: [HOME, carHub, { name: "Best comprehensive", url: "/car-insurance/best-comprehensive/" }] },
  { path: "/car-insurance/car-insurance-companies/", title: "Car Insurance Companies in Australia: Who Underwrites What", description: "A guide to Australian car insurance companies, the major underwriting groups (Suncorp, IAG, Allianz, QBE, Auto & General, Youi), the brands beneath them, and how to check who's really carrying your risk.", breadcrumbs: [HOME, carHub, { name: "Car insurance companies", url: "/car-insurance/car-insurance-companies/" }] },
  { path: "/car-insurance/insurance-comparison-sites/", title: "Car Insurance Comparison Sites in Australia: How They Work and What They Miss", description: "How Australian car insurance comparison sites work, who's on the panel and who isn't, how they make money, and how to use them well alongside off-panel insurers.", breadcrumbs: [HOME, carHub, { name: "Comparison sites", url: "/car-insurance/insurance-comparison-sites/" }] },
  ...
  // Reviews
  { path: "/reviews/", title: "Australian Car Insurance Provider Reviews and Comparisons", description: "Plain-English overviews of 16 Australian car insurance providers and 10 head-to-head comparisons, neutral, evergreen, no fake ratings.", breadcrumbs: [HOME, reviewsHub] },
  { path: "/reviews/budget-friendly/", title: "Budget-Friendly Australian Car Insurance Providers", description: "Six Australian car insurers that publicly position around price, including pay-as-you-drive options. Plain-English overviews, key facts and links to each review.", breadcrumbs: [HOME, reviewsHub, { name: "Budget-friendly", url: "/reviews/budget-friendly/" }] },
